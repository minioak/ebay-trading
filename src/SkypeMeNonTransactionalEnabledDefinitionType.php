...
{
    const TAG = 'SkypeMeNonTransactionalEnabledDefinitionType';
    const NAME = 'SkypeMeNonTransactionalEnabledDefinitionType';
...
SkypeMeNonTransactionalEnabledDefinitionType::_register();
